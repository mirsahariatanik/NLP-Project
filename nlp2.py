...
def generate_event(event_set,participant_set,week_set,day_set,hour_set,ampm_set):
    ...
    #print(e[0])
    if (hour=='12'):
        event_generated = 'schedule'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'at' + ' ' + hour+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'at'+':O'+' '+ hour+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'at'+':O'+' '+ hour+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'schedule' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+week+' '+ day+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+'1'+ampm+' '+')'
    else:
        event_generated = 'schedule'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'at' + ' ' + hour+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'at'+':O'+' '+ hour+ampm+':B-end-time'
            ...
            eve= 'schedule:O'+' '+'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'at'+':O'+' '+ hour+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'schedule' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+week+' '+ day+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+str(int(hour)+1)+ampm+' '+')'
