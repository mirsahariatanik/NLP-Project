...
def generate_event(event_set,participant_set,week_set,day_set,hour_set,ampm_set):
    ...
    #print(e[0])
    if (hour=='12'):
        event_generated = event + ' ' + 'with'  + ' ' + participant + ' ' + 'on the' + ' ' + dates + ' ' + 'from' + ' ' + hour+ampm+' '+'to'+ ' '+ '1'+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '1'+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '1'+ampm+':B-end-time'
        ...
        event_generated = event + ' ' + 'with'  + ' ' + participant + ' ' + 'on the' + ' ' + dates + ' ' +'from' + ' ' + hour+ampm+' '+'to'+ ' '+ str(int(hour)+1)+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' +' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+1)+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' +' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+1)+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
