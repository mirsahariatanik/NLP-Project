...
def generate_event(event_set,participant_set,week_set,day_set,hour_set,ampm_set):
    ...
    #print(e[0])
    if (hour=='12'):
        event_generated = 'schedule'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'from' + ' ' + hour+ampm+' '+'to'+ ' '+ '2'+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '2'+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '2'+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'schedule' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+week+' '+ day+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+'2'+ampm+' '+')'
    else:
        event_generated = 'schedule'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'from' + ' ' + hour+ampm+' '+'to'+ ' '+ str(int(hour)+2)+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+2)+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+2)+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'schedule' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+week+' '+ day+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+str(int(hour)+2)+ampm+' '+')'
