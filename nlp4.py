...
def generate_event(event_set,participant_set,week_set,day_set,hour_set,ampm_set):
    ...
    #print(e[0])
    if (hour=='12'):
        event_generated = 'set'+' '+'reminder'+ ' '+ 'for' +' '+event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'from' + ' ' + hour+ampm+' '+'to'+ ' '+ '1'+ampm
        if (len(e)==1):
            eve= 'reminder:O'+' '+'set:O'+' '+'reminder:O'+' '+'for:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '1'+ampm+':B-end-time'
        else:
            eve= 'reminder:O'+' '+'set:O'+' '+'reminder:O'+' '+'for:O'+' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '1'+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'reminder' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+week+' '+ day+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+'1'+ampm+' '+')'
    else:
        event_generated = 'reminder'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'from' + ' ' + hour+ampm+' '+'to'+ ' '+ str(int(hour)+1)+ampm
        if (len(e)==1):
            eve= 'reminder:O'+' '+'set:O'+' '+'reminder:O'+' '+'for:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+1)+ampm+':B-end-time'
        else:
            eve= 'reminder:O'+' '+'set:O'+' '+'reminder:O'+' '+'for:O'+' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+1)+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'reminder' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+week+' '+ day+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+str(int(hour)+1)+ampm+' '+')'
