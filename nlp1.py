...
def generate_event(event_set,participant_set,week_set,day_set,hour_set,ampm_set):
    ...
    #print(e[0])
    if (hour=='12'):
        event_generated = 'schedule'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + 'on the' + ' ' + dates + ' ' + 'from' + ' ' + hour+ampm+' '+'to'+ ' '+ '1'+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '1'+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' + ' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ '1'+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'schedule' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+ dates+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+'1'+ampm+' '+')'
    else:
        event_generated = 'schedule'+ ' ' +event + ' ' + 'with'  + ' ' + participant + ' ' + 'on the' + ' ' + dates + ' ' +'from' + ' ' + hour+ampm+' '+'to'+ ' '+ str(int(hour)+1)+ampm
        if (len(e)==1):
            eve= 'schedule:O'+' '+'schedule:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' +' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+1)+ampm+':B-end-time'
        else:
            eve= 'schedule:O'+' '+'schedule:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+'on:O'+' '+'the:O'+' '+dates+':B-date' +' '+ 'from'+':O'+' '+ hour+ampm+':B-start-time'+' '+'to'+':O'+' '+ str(int(hour)+1)+ampm+':B-end-time'
        #find_taxi ( taxi-destination = backstreet bistro ; taxi-arriveby = 19:30 )
        frame= 'schedule' +' '+'('+' '+'title'+' '+'=' + ' '+ event+' '+'with'+ ' '+participant+' '+';'+ ' '+'date'+' '+ '='+' '+ dates+' '+';'+' '+'start-time'+' '+'='+' '+hour+ampm+' '+';'+' '+'end-time'+' '+'='+' '+str(int(hour)+1)+ampm+' '+')'
    event_frame= event_generated+ '\t'+ frame
    event_bio= eve
    data_act= event_generated+'\t' + 'schedule'
    act= 'schedule'
