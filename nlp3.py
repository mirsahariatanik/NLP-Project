...
def generate_event(event_set,participant_set,week_set,day_set,hour_set,ampm_set):
    ...
    #print(e[0])
    if (hour=='12'):
        event_generated = 'set'+' '+'reminder'+ ' '+ 'for' +' '+event + ' ' + 'with'  + ' ' + participant + ' ' + week + ' ' + day + ' ' + 'at' + ' ' + hour+ampm
        if (len(e)==1):
            eve= 'reminder:O'+' '+'set:O'+' '+'reminder:O'+' '+'for:O'+' '+event+ ':B-title'+ ' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'at'+':O'+' '+ hour+ampm +':B-end-time'
        else:
            eve= 'reminder:O'+' '+'set:O'+' '+'reminder:O'+' '+'for:O'+' '+e[0]+ ':B-title'+ ' '+e[1]+ ':I-title'+' '+'with' + ':I-title'+' '+participant+':I-title'+' '+week+':B-date' +' '+ day+':I-date' + ' '+ 'at'+':O'+' '+ hour+ampm+':B-end-time'
